-- Tao co so du lieu voi collation utf8mb4
...
-- Bang Appointments (luu thong tin lich hen, ho tro cho "Lich hen hom nay" neu can)
...
-- Bang MedicalRecords (luu ho so y te, ho tro cho "Benh nhan can chu y" neu can)
...
-- 1. UserAccounts (5 ban ghi: 3 bac si, 2 benh nhan)
INSERT INTO UserAccounts (UserID, UserName, FullName, Role, Email, PhoneNumber, Password) VALUES
                                                                                              ('U001', 'doctor1', 'Nguyen Van An', 'Bac si', 'nguyenvanan@example.com', '0987654321', 'admin123'),
                                                                                              ('U002', 'doctor2', 'Tran Thi Binh', 'Bac si', 'tranthibinh@example.com', '0976543210', 'admin123'),
                                                                                              ('U003', 'doctor3', 'Le Van Cuong', 'Bac si', 'levancuong@example.com', '0912345678', 'admin123'),
                                                                                              ('U004', 'doctor4', 'Pham Thi Dung', 'Bac si', 'phamthidung@example.com', '0908765432', 'admin123'),
                                                                                              ('U005', 'doctor5', 'Hoang Van Em', 'Bac si', 'hoangvanem@example.com', '0933456789', 'admin123');
...
INSERT INTO Patients (PatientID, UserID, FullName, DateOfBirth, Gender, PhoneNumber, Address, CreatedAt) VALUES
                                                                                                             ('P001', 'U004', 'Pham Thi Dung', '1990-05-15', 'Nu', '0908765432', '123 Duong Lang, Ha Noi', '2025-04-01'),
                                                                                                             ('P002', 'U005', 'Hoang Van Em', '1985-03-20', 'Nam', '0933456789', '456 Duong Giai Phong, Ha Noi', '2025-04-02'),
                                                                                                             ('P003', 'U001', 'Nguyen Thi Hoa', '1992-07-10', 'Nu', '0945678901', '789 Duong Cau Giay, Ha Noi', '2025-04-03'),
                                                                                                             ('P004', 'U002', 'Tran Van Khai', '1988-11-25', 'Nam', '0956789012', '101 Duong Kim Ma, Ha Noi', '2025-04-04'),
                                                                                                             ('P005', 'U003', 'Le Thi Lan', '1995-09-30', 'Nu', '0967890123', '202 Duong Nguyen Trai, Ha Noi', '2025-04-05');
