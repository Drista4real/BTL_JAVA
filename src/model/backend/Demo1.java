...
public class Demo1 {
    ...
    public void DocFile() {
        try {
            ...
            while (scr.hasNextLine()) {
                ...
                if (thongtin.equals("@") && flag == true) {
                    ...
                    if (mabn != null && hoten != null && nnv != null && mabh != null) {
                        try {
                            // Chỉ có BENHNHANBAOHIEMYTE, không còn BENHNHANBAOHIEMXAHOI
            ...
            if (flag) {
                // Chỉ khởi tạo BENHNHANBAOHIEMYTE, không còn BENHNHANBAOHIEMXAHOI
                BENHNHAN benhnhan = new BENHNHANBAOHIEMYTE(lbn, mabn, ghichu, lichhen, hoten, nnv, mabh, phongtyc);
                Danhsach.put(benhnhan.getMABN(), benhnhan);
            }
    ...
    public void GhiChuBS(String mabn, String GhiChumoi) throws Exception {
        ...
        if (benhnhan != null) {
            ...
            // kiểm tra nếu có ghi chú thì in ra thông báo
