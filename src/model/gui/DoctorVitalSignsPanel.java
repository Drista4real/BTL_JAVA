...
import model.entity.VitalSignsService;
...
import java.util.List;
        ...
        public class DoctorVitalSignsPanel extends JPanel {
            private User user;
            ...
            public DoctorVitalSignsPanel(User user) {
                if (user.getRole() != Role.DOCTOR) {
                    throw new IllegalArgumentException("Chỉ bác sĩ được phép sử dụng panel này!");
                }
                this.user = user;
                this.vitalSignsList = new ArrayList<>();
                this.vitalSignsService = new VitalSignsService(this);
            ...
            private JPanel createInputPanel() {
                ...
                JButton loadButton = new JButton("Tải dấu hiệu sinh tồn");

                loadButton.addActionListener(e -> loadVitalSigns());
            ...
            private void loadVitalSigns() {
                ...
                try {
                    vitalSignsList = vitalSignsService.loadVitalSignsByPatientId(patientId);
                    updateVitalSignsTable(vitalSignsList);
                    if (vitalSignsList.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Không tìm thấy dấu hiệu sinh tồn cho bệnh nhân: " + patientId, "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                    }
            ...
            private JPanel createButtonPanel() {
                ...
                refreshButton.addActionListener(e -> loadVitalSigns());
            ...
            private void showAddVitalSignsDialog() {
                String patientId = patientIdField.getText().trim();
                if (patientId.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Vui lòng nhập mã bệnh nhân trước!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                JTextField patientIdField = new JTextField(patientId, 15);
                ...
                saveButton.addActionListener(e -> {
                    try {
                        // Tạo ID mới
                        String id = vitalSignsService.generateVitalSignsId();
                        ...
                        vitalSignsService.saveVitalSigns(vitalSigns);

                        // Thêm vào danh sách và cập nhật bảng
                        addVitalSigns(vitalSigns);
                        dialog.dispose();
                        JOptionPane.showMessageDialog(this, "Đã thêm bản ghi dấu hiệu sinh tồn!", "Thành công", JOptionPane.INFORMATION_MESSAGE);
                        ...
                        JOptionPane.showMessageDialog(dialog,
                                "Lỗi khi lưu vào cơ sở dữ liệu: " + ex.getMessage(),
            ...
            private void filterByPatientId(String patientId) {
                ...
                for (VitalSigns vs : vitalSignsList) {
                    if (vs.getPatientId().equals(patientId)) {
                        filteredList.add(vs);
                    }
                }
